...
5. 每句以"我现在 / 我正在 / 我总是 / 我充满 / 我拥有 / 我值得 / 我享受"等正向句式开头，具体、贴合处境、10-22 字；尊重用户"不想听到什么"的要求。
6. 不评判、不说教、不命令，只写正面的自我陈述。
7. 全部使用简体中文。
...
{"title":"《我现在稳稳地表达自己》","scene":"面试前","emotionTags":["紧张","压力","自我怀疑"],"understanding":"你不是能力不足，而是对未知结果感到失控。","targetState":"稳定、自信、可行动","strategy":["降低比较感","恢复掌控感","强化行动感"],"affirmations":["我现在沉稳而清晰，我从容地表达自己。","我已经准备充分，我值得这个机会。","我专注于当下，我的节奏稳稳的。"],"anchorLine":"我此刻沉稳、清晰，我自信地表达自己。","suggestedSoundscape":"confidence","mood":"firm"}`;
}
