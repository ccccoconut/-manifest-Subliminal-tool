...
export default function InputStep({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl text-center">
      ...
      <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-[var(--color-mist-soft)]">
        可以说说你的现状、担心或者期许~酥饼会自动生成适合你的肯定语。
      </p>

      <div className="glass mt-5 rounded-[var(--radius-2xl)] p-4 text-left sm:p-5">
        <textarea
          value={message}
          ...
          className="w-full resize-none rounded-3xl bg-black/[0.05] p-4 text-base leading-relaxed text-[var(--color-mist)] outline-none placeholder:text-[var(--color-haze)] focus:bg-black/[0.07] sm:p-5 sm:text-lg"
        />
